...
namespace BackgroundImageSorter.Utilities
{
    ...
    {
        public static string DetectProperExtension(string filePath)
        {
            ...
            // or 
            Stream fileDataStream = File.Open(filePath, FileMode.OpenOrCreate, FileAccess.Read, FileShare.None);
